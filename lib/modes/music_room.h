...
private:
	...
	const struct MusicInfo infoMaster[MUSIC_NUM] = {
		{ 1,	"m4a",	"It's Maxence!!!",					CHARACTER_WHO_NONE,			"オープニング曲。一番最初に作りました。\n冒険に胸躍らせるわくわく感が伝われば嬉しいです♪\nえ、本編で冒険してないって？ 気のせいでしょ。" },
		{ 2,	"ogg",	"Mr.K is talking to you",			CHARACTER_WHO_PL_YELLOW,	"Mr.Kのテーマ。チュートリアルで流れます。\n突然語りかけてくるアイツの怪しさを表現しました♪\nちなみに彼は全裸サングラスです。イカしてますね！" },
		{ 3,	"ogg",	"海と樹海と私",						CHARACTER_WHO_NONE,			"世界（部屋）を包み込む不穏な曲...樹海！樹海！\n樹海！樹海！樹海！樹海！樹海！樹海！樹海！樹海！\nさて問題！いま何回「樹海」っていったでしょうか？" },
		{ 4,	"ogg",	"Mr.K is shouting at you",			CHARACTER_WHO_RED,			"激昂して襲いかかってくる赤いアイツのテーマ。\n赤いアイツはモデルとなる人がいるとかいないとか。\nおっと誰か来たようだ..." },
		{ 5,	"ogg",	"Mr.K is smiling on you",			CHARACTER_WHO_GREEN,		"仲間の死を悼む緑のアイツのテーマ。\n緑のアイツは割といいやつなイメージがあります。\n彼は最後にいったい何を悟ったのでしょうか？？" },
		{ 6,	"ogg",	"Mr.K is lying to you",				CHARACTER_WHO_BLUE,			"謀略に長けた青いアイツのテーマ。\n野心から仲間を切り捨て王を目指す悲しいアイツ。\n狡猾さと悲しさが表現できていれば幸いです♪" },
		{ 7,	"ogg",	"運命の平衡点",						CHARACTER_WHO_NONE,			"真実を悟る時の曲。曲名は脚本のA氏による命名。\n冬に寒い寒いって思いながら作った記憶があります。\n運命にも平衡点はあるんだよなぁ..." },
		{ 8,	"ogg",	"Mr.K is playing with you",			CHARACTER_WHO_YELLOW,		"操作キャラだった黄色いアイツと戦う時のテーマ。\nチュートリアル曲のアレンジになっています。\nMr.Kらしい曲を目指しました♪" },
		{ 9,	"ogg",	"鹿は静かに森に帰る",				CHARACTER_WHO_NONE,			"表エンディング曲。曲名は脚本のA氏による命名。\nなぜ鹿なのか？本当に鹿なのか？なぜ森に帰るのか？\nそれは鹿のみが知っているのである。" },
		{ 10,	"ogg",	"Waterly blue mountain",			CHARACTER_WHO_NONE,			"プログラム担当のT氏との合作。ボーナストラック。\n曲名の由来は製作者の一人の名前という噂が...\nこれ以上書くと怒られちゃいそうなのでこの辺で。" },
		{ 11,	"ogg",	"Dear The Deer",					CHARACTER_WHO_DEER,			"裏ルート突入！！謎の鹿のテーマ曲。\n戦い前の静かだけどバチバチとした雰囲気を\n感じられる曲になっていれば嬉しいです♪" },
		{ 12,	"ogg",	"The biggest deer",					CHARACTER_WHO_DEER,			"裏ラスボス戦の曲。直訳すると最も大きな鹿。\n空間を操る能力があるとか。\n得体の知れない感じが表現できていれば嬉しいです♪" },
		{ 13,	"ogg",	"行き場を失った博士たちのブルース",	CHARACTER_WHO_NONE,			"真エンディング。ここまで遊んでくれてありがとう。\nあなたこそが本当のMr.Kなのかもしれない。\nブルースって多分こんな感じだよね、たぶん..." },
		{ 14,	"ogg",	"Fading memories",					CHARACTER_WHO_NONE,			"けっこう壮大な雰囲気の曲になりました。\n作ったはいいけど使う場面がなくて...\n...いわゆるボーナストラックというやつですね！" },
		{ 15,	"ogg",	"釣り船",							CHARACTER_WHO_NONE,			"ゲームオーバー時に流れます。\n一回も聞かずにクリアできたあなたはスゴイ！！\n侘び寂びを表現することを目指して作りました。" },
	};
	const struct MusicInfo lockedMusicInfo = { 0, "wav", "??????????", CHARACTER_WHO_NONE, "この曲はまだ聞いたことがないよ" };
